 ...
 * Moderate product reviews (requires REVIEW_MANAGEMENT permission)
 */
...
export default function StaffReviewsModerationPage() {
    ...
    const checkPermission = async () => {
      try {
        ...
        const hasReviewPermission =
          permissionCodes.includes("REVIEW_MANAGEMENT") ||
          profile?.staff?.user?.role === "ADMIN";
        setHasPermission(hasReviewPermission);
  ...
  }, [hasPermission, statusFilter, sortBy]);
