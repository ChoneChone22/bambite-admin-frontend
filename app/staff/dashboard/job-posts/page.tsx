...
/**
 * Staff Job Post Management Page
 * CRUD operations for job posts (requires recruitment_management permission)
 */
                  ...
                  {({ push, remove, form }) => (
                    <div className="space-y-2">
                      ...
                      <button
                        type="button"
                        onClick={() => push("")}
                        className="text-sm hover:underline cursor-pointer text-foreground"
                      >
                        + Add Task
                      </button>
                    </div>
