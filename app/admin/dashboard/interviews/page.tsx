...
/**
 * Admin Interview Management Page
 * Create and manage interviews for job applications
 */
      ...
      <div className="mb-6 flex gap-4 flex-wrap">
        ...
        {dateFilter && (
          <button
            ...
            className="px-4 py-2 bg-gray-200 rounded hover:bg-gray-300 text-foreground"
          >
            Clear Date Filter
          </button>
        )}
      ...
      <div className="bg-card rounded-lg shadow overflow-hidden">
        ...
        {totalRows === 0 && (
          <div className="text-center py-12">
            <p className="text-foreground">No interviews found</p>
          </div>
        )}
      </div>
